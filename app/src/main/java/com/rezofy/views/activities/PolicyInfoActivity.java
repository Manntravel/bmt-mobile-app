...
public class PolicyInfoActivity  extends AppCompatActivity implements View.OnClickListener,  NetworkTask.Result {
    ...
    private void init()
    {
        ...
        tvTitle.setText(getString(R.string.policy_info));
