 ...
 */
public class OneWayInternationalFlightsSearchAdapter extends RecyclerView.Adapter<OneWayInternationalFlightsSearchAdapter.ViewHolder> {

    private static final int TYPE_ITEM = 1;
    private  List     getList;
    private  Context  context;
    public OneWayInternationalFlightsSearchAdapter(List getList, Context context)
    {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_rc_view_international_oneway, parent, false);
